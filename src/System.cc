...
Sophus::SE3f System::TrackMonocularMask(const cv::Mat &im, const cv::Mat &mask, const double &timestamp, const vector<IMU::Point>& vImuMeas, string filename)
{
    ...
    Sophus::SE3f Tcw = mpTracker->GrabImageMonocularMask(imToFeed,maskToFeed,timestamp,filename);
